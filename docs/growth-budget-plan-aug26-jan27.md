...
| Brand-ops associate — ₹20k/mo, Sep 1 start (recruited in August) · **⏸ UNDER RECONSIDERATION as of Aug 16 — JD unposted, Adi weighing whether to hire at all; see Week 2 task 7. Held in the budget until he decides. If dropped, ₹1,00,000 returns to the pool and B5a's duties return to Adi.** | ₹1,00,000 |
...
**⏸ Conditional as of Aug 16, 2026.** The associate hire is under reconsideration (Week 2 task 7). If the hire doesn't happen, every duty in the left-hand column reverts to Adi — this table then describes work that still has to be done, just by him. Nothing in it becomes optional.
...
7. **⏸ ON HOLD PENDING ADI'S DECISION (Aug 16) — post the associate JD.** JD is **not posted**, and Adi is **reconsidering the hire entirely**. This is a founder decision, not a plan decision, so it is recorded here rather than resolved. The consequences either way:
   - **Hire (plan as written):** ₹1,00,000 of the ₹15L across Sep–Jan. A Sep 1 start needed the JD up ~Aug 10 and needs ~3 weeks end-to-end; **posting by Aug 17 is already the compressed version.** Past Aug 17 the realistic start is Sep 8–15, and the whole B5a delegation map (product uploads, nutrient data entry across ~150 SKUs, brand admin, daily metrics entry) shifts with it.
   - **Don't hire:** ₹1,00,000 frees up inside the ceiling — real money, roughly three months of the Meta line. But every B5a duty returns to Adi, at 150 SKUs, in the same weeks he is also running deliveries, societies, content and a conversion fix. The hire was justified on shelf accuracy: 150 listings that nobody maintains go stale (wrong prices, missing scores, dead photos) and that failure is invisible until customers hit it.
   - **Defer (decide at the Aug 31 close):** costs nothing today and keeps ₹1L uncommitted, at the price of a Sep 15+ start if the answer turns out to be yes.

   **Reading it against today's numbers:** the case for deferring is stronger than it was on Aug 10. The binding constraint this month is a 5% install→order rate, and an associate does not fix conversion — that work is Adi's and is not delegable. The case *against* deferring is that the associate was never meant to fix growth; they exist so shelf upkeep doesn't eat the founder's hours during exactly this kind of firefight. **Recommendation: defer the decision to the Aug 31 month close, and don't post the JD this week** — but if the answer is going to be yes, know that every week of delay pushes the start into mid-September and the Diwali build-up. Adi decides; the plan follows.

   Original task text retained below for when/if the hire proceeds. This was scheduled Aug 10 and is already late; it was the tightest item in the plan. Sep 1 start needs ~3 weeks end-to-end (post → 20 applicants → screen to 5 → interview → offer), and at 150 SKUs the hire is not optional. Do NOT let this slide behind the launch firefight. Title: "Brand & Ops Associate — Cosmo (Bandra West, in-person)". Body: what Cosmo is (2 lines), the B5a delegate column as the duties list, "₹20,000/month, start Sep 1, work from Bandra West". Post on: Internshala, LinkedIn (your profile + Kunal reposts), your college/startup WhatsApp groups, and ask the society champions ("know a smart fresh grad in Bandra?" — a local hire who knows the neighbourhood is worth extra). Goal: 20+ applicants by Aug 17.
...
- **Aug 16, 2026 — associate hire under reconsideration.** The ₹1,00,000 line (A1) is held, not cancelled. No change to the ceiling either way; if Adi decides against the hire, that ₹1,00,000 returns to uncommitted budget and this note gets replaced with the decision.
